...
export function CommandPalette({
  ...
  const actions: Action[] = useMemo(
    () => [
      ...
      {
        id: "route-agent-economy",
        label: "Route: /marketplace/agent-economy",
        group: "Router",
      ...
      {
        id: "route-pay-unlock",
        label: "Route: /marketplace/pay (wallet)",
        group: "Router",
      ...
      {
        id: "route-live-ops",
        label: "Route: /marketplace/live",
        group: "Router",
        run: () => { window.location.assign("/marketplace/live"); },
      },
      {
        id: "route-simulate",
        label: "Route: /marketplace/simulate",
        group: "Router",
        run: () => { window.location.assign("/marketplace/simulate"); },
      },
      {
        id: "route-kit",
        label: "Route: /marketplace/kit",
        group: "Router",
      ...
      {
        id: "route-protocols",
        label: "Route: /marketplace/protocols",
        group: "Router",
        run: () => { window.location.assign("/marketplace/protocols"); },
      },
      {
        id: "route-intent",
        label: "Route: /marketplace/intent",
        group: "Router",
        run: () => { window.location.assign("/marketplace/intent"); },
      },
      {
        id: "route-trust",
        label: "Route: /marketplace/trust",
        group: "Router",
