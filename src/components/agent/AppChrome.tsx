...
const NAV = [
  ...
  { href: "/marketplace/product", label: "Product OS", route: true },
          ...
          {NAV.map((item) => (
            <li key={item.href}>
              {"route" in item && item.route ? (
                <Link
                  to={item.href as "/ops/board" | "/lab/router" | "/lab/loaders" | "/lab/interop" | "/lab/settlement" | "/marketplace" | "/marketplace/agent-economy" | "/marketplace/product" | "/skills"}
